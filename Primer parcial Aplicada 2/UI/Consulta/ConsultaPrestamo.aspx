<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Master Page/Master.Master" AutoEventWireup="true" CodeBehind="ConsultaPrestamo.aspx.cs" Inherits="Primer_parcial_Aplicada_2.UI.Consulta.ConsultaPrestamo" %>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-5 col-lg-2">
                <asp:DropDownList ID="FiltroComboBox" runat="server" CssClass="form-control">
                    ...
                    <asp:ListItem Text="IdPrestamo"></asp:ListItem>
                    <asp:ListItem Text="IdCuenta"></asp:ListItem>
                    <asp:ListItem Text="Interes"></asp:ListItem>
                    <asp:ListItem Text="Tiempo"></asp:ListItem>
                    <asp:ListItem Text="Capital"></asp:ListItem>
                </asp:DropDownList>
            ...
            <div class="col-md-12 col-sm-12">
                <asp:GridView ID="DatosGridView" AllowPaging="true" PageSize="8" OnPageIndexChanging="DatosGridView_PageIndexChanging" runat="server" Width="100%" class="table table-responsive text-center" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="IdCuenta" HeaderText="IdCuenta" />
