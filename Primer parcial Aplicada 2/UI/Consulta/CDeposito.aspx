<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Master Page/Master.Master" AutoEventWireup="true" CodeBehind="CDeposito.aspx.cs" Inherits="Primer_parcial_Aplicada_2.UI.Consulta.CDeposito" %>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-5 col-lg-2">
                <asp:DropDownList ID="FiltroComboBox" runat="server" CssClass="form-control">
                    ...
                    <asp:ListItem Text="IdDeposito"></asp:ListItem>
                    <asp:ListItem Text="Concepto"></asp:ListItem>
